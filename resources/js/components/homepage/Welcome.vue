                ...
                <div class="row">
                    <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
                        <div>
                            ...
                            <a href="/retrospective/create" class="download-btn"><i class='bx bx-calendar-check' ></i> Start a meeting!</a>
                            <a href="/retrospective/create" class="download-btn"><i class='bx bxs-hand-right'></i> Join a meeting</a>
                        </div>
                    </div>
