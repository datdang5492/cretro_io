                    ...
                    <div class="row justify-content-between">
                        <div class="col">
                            <p class="text-muted"> Shipment ID <span
                                class="font-weight-bold text-dark">{{orderId}}</span>
                            </p>
                            <p class="text-muted"> Place On
                                <!--<span class="font-weight-bold text-dark">12,March 2019</span>-->
                                <span class="font-weight-bold text-dark">{{shipment.created_at}}</span>
                            </p>
                        </div>
                    ...
                    <div class="media flex-column flex-sm-row">
                        <div class="media-body ">
                            ...
                            <h6 class="mt-3 mb-4 bold">Total price:
                                ...
                                <span class="mt-5">{{shipment.currency}}</span> {{shipment.total}}
                                <span class="small text-muted">via </span>
                                <i class="title-size1 fab fa-paypal text-primary"></i>
                                <!--<span class="small text-muted text-uppercase"> Paypal</span>-->
                                <span class="small text-muted text-uppercase"> {{shipment.paymentMethod}}</span>
                            </h6>
                            <!--<p class="text-muted"> Weight: 4 kg</p>-->
                            <p class="text-muted"> Weight: {{shipment.totalWeight}} kg</p>
                            <p class="text-muted">Last update on:
                                <span class="today">11:30pm, March 15, 2020</span>
                                <!--<span class="today">{{shipment[shipment['progress'].length - 1].created_at}}</span>-->
                            </p>
                        </div>
